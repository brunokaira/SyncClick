          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm text-muted-foreground capitalize">{member.role.name}</p>
              </div>
              ...
              <div className="ml-auto text-sm text-muted-foreground text-right">
                ...
                <p className="font-medium text-foreground">{member.joinedAt ? format(member.joinedAt, "PPP") : null}</p>
              </div>
            </li>
          );
        })}
