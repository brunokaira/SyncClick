...
// Real-time updates are handled globally by SocketProvider in app.layout.tsx.
// This component just needs to subscribe to the query; SocketProvider will
// invalidate ["all-tasks", workspaceId] whenever a task event is received.
