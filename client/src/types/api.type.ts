...
export type CreateTaskPayloadType = {
  ...
  data: {
    ...
    assignedTo?: string | null; // <-- Now optional/nullable
    dueDate: string;
  };
};
...
export type EditTaskPayloadType = {
  ...
  data: Partial<{
    ...
    priority: TaskPriorityEnumType;
    status: TaskStatusEnumType;
    assignedTo: string | null; // <-- Now nullable
    dueDate: string;
  }>;
};
...
// ── Deletion Audit Log ────────────────────────────────────────────────────────
export type DeletedTaskLogType = {
  _id: string;
  taskCode: string;
  title: string;
  ...
  priority: TaskPriorityEnumType;
  dueDate?: string | null;
  project?: { _id: string; name: string; emoji: string } | null;
  assignedTo?: { _id: string; name: string; profilePicture: string | null } | null;
  createdBy?: { _id: string; name: string } | null;
  deletedBy: { _id: string; name: string; profilePicture: string | null };
  deletedAt: string;
};

export type DeletedTaskLogsResponseType = {
  message: string;
  logs: DeletedTaskLogType[];
  pagination: PaginationType;
};
